...
export const tasksData = [
  ...
  { id: 'TSK-008', trk: 'LQ-8847308', sz: 'S', tab: 'inTransit', locker: 'West Hills Mall', addr: 'Weija Junction, Accra', eta: '12:00 PM', sender: 'Prince Tagoe', receiver: 'Dede Ayew', phone: '+233 55 444 6666', acceptedAt: '10:05 AM', inTransitAt: '10:20 AM' },
  { id: 'TSK-009', trk: 'LQ-8847309', sz: 'L', tab: 'deposited', locker: 'Accra Mall', addr: 'Tetteh Quarshie, Accra', eta: '9:00 AM', sender: 'Obed Asamoah', receiver: 'Mansa Keita', phone: '+233 20 777 8888', acceptedAt: '9:15 AM', inTransitAt: '9:25 AM', depositedAt: '9:42 AM' },
  { id: 'TSK-010', trk: 'LQ-8847310', sz: 'S', tab: 'deposited', locker: 'Achimota Mall', addr: 'Mile 7, Achimota', eta: '9:30 AM', sender: 'Gifty Lamptey', receiver: 'Kofi Annan', phone: '+233 24 000 1111', acceptedAt: '9:35 AM', inTransitAt: '9:45 AM', depositedAt: '10:05 AM' },
  { id: 'TSK-011', trk: 'LQ-8847311', sz: 'M', tab: 'recall', locker: 'Accra Mall', addr: 'Tetteh Quarshie, Accra', eta: '10:30 AM', sender: 'Ama Mensah', receiver: 'Yaw Asante', phone: '+233 24 333 5555', recallType: 'customerCancel', recallStatus: 'pendingPickup', returnDest: 'Warehouse' },
  { id: 'TSK-012', trk: 'LQ-8847312', sz: 'S', tab: 'recall', locker: 'West Hills Mall', addr: 'Weija Junction, Accra', eta: '12:00 PM', sender: 'Kweku Baah', receiver: 'Efua Nyarko', phone: '+233 55 888 9999', recallType: 'wrongAddress', recallStatus: 'pendingPickup', returnDest: 'Achimota Mall' },
];
