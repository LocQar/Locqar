...
const ROLES = {
  SUPER_ADMIN: { id: 'super_admin', name: 'Super Admin', level: 100, color: '#3B82F6', permissions: ['*'] },
  ADMIN: { id: 'admin', name: 'Administrator', level: 80, color: '#D97706', permissions: ['dashboard.*', 'packages.*', 'lockers.*', 'dropbox.*', 'terminals.*', 'customers.*', 'staff.*', 'reports.*', 'dispatch.*', 'accounting.*', 'crm.*'] },
  MANAGER: { id: 'manager', name: 'Branch Manager', level: 60, color: '#10B981', permissions: ['dashboard.view', 'packages.*', 'dropbox.*', 'lockers.*', 'terminals.view', 'customers.*', 'staff.view', 'reports.view', 'dispatch.*', 'crm.view'] },
  AGENT: { id: 'agent', name: 'Field Agent', level: 40, color: '#8B5CF6', permissions: ['dashboard.view', 'packages.view', 'packages.scan', 'packages.receive', 'dropbox.view', 'dropbox.collect', 'lockers.view', 'lockers.open', 'dispatch.view'] },
  SUPPORT: { id: 'support', name: 'Support', level: 30, color: '#EF4444', permissions: ['dashboard.view', 'packages.view', 'packages.track', 'customers.*', 'tickets.*'] },
  VIEWER: { id: 'viewer', name: 'View Only', level: 10, color: '#64748B', permissions: ['dashboard.view', 'packages.view', 'lockers.view'] },
  CUSTOMER: { id: 'customer', name: 'Customer', level: 5, color: '#D97706', permissions: ['packages.view.own', 'subscription.view', 'profile.manage'] },
};
